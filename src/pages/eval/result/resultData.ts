...
export const personResults: PersonResult[] = [
  { id: '26040002', name: '이서연', dept: '인사팀', rank: '과장', selfScore: 90, managerScore: 92, totalScore: 91.4, autoGrade: 'S', finalGrade: 'S', isCalibrated: false,
    detail: {
      goals: [
  ...
  { id: '26040008', name: '윤재혁', dept: '개발팀', rank: '부장', selfScore: 85, managerScore: 88, totalScore: 87.1, autoGrade: 'A', finalGrade: 'S', isCalibrated: true,
    detail: {
      itemScores: [
  ...
  { id: '26040001', name: '김민수', dept: '개발팀', rank: '대리', selfScore: 82, managerScore: 85, totalScore: 84.1, autoGrade: 'A', finalGrade: 'A', isCalibrated: false,
    detail: {
      itemScores: [
  ...
  { id: '26040005', name: '정하은', dept: '재무팀', rank: '차장', selfScore: 88, managerScore: 90, totalScore: 89.4, autoGrade: 'S', finalGrade: 'A', isCalibrated: true,
    detail: {
      itemScores: [
  ...
  { id: '26040007', name: '오나영', dept: '경영지원팀', rank: '대리', selfScore: 80, managerScore: 82, totalScore: 81.4, autoGrade: 'B', finalGrade: 'B', isCalibrated: false },
  { id: '26040004', name: '최유진', dept: '영업팀', rank: '주임', selfScore: 75, managerScore: null, totalScore: null, autoGrade: 'B', finalGrade: 'B', isCalibrated: false },
  { id: '26040003', name: '박지훈', dept: '마케팅팀', rank: '사원', selfScore: 70, managerScore: null, totalScore: null, autoGrade: 'C', finalGrade: 'C', isCalibrated: false },
  { id: '26040006', name: '한승우', dept: '개발팀', rank: '사원', selfScore: null, managerScore: null, totalScore: null, autoGrade: null, finalGrade: null, isCalibrated: false },
]
