...
const mockAppeals: Appeal[] = [
  {
    ...
    reason: '상위자평가 점수가 실제 업무 기여도에 비해 과소 반영되었다고 판단됩니다. 프로젝트 X에서 핵심 모듈을 전담 개발하였으나 이 부분이 충분히 반영되지 않았습니다.',
    status: '기각',
    hrComment: '상위자평가 결과는 해당 시즌 전체 성과를 종합한 것으로, 개별 프로젝트 기여도만으로 조정하기 어렵습니다.',
  },
]
