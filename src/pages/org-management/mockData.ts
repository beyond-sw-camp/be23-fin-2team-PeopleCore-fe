...
export const mockOrders: PersonnelOrder[] = [
  { id: 'ord-1', type: 'promotion', employeeId: '5', employeeName: '최동혁', fromDepartment: '재무회계팀', toDepartment: '재무회계팀', fromRank: '과장', toRank: '차장', fromPosition: '-', toPosition: '-', effectiveDate: '2026-04-01', status: 'scheduled', notified: true, createdBy: '김철수', createdAt: '2026-03-25T10:00:00', memo: '2026년 상반기 정기 승진' },
  { id: 'ord-2', type: 'transfer', employeeId: '10', employeeName: '송태현', fromDepartment: '프론트엔드팀', toDepartment: '백엔드팀', fromRank: '사원', toRank: '사원', fromPosition: '-', toPosition: '-', effectiveDate: '2026-04-01', status: 'scheduled', notified: false, createdBy: '김철수', createdAt: '2026-03-26T11:00:00', memo: '백엔드 인력 보강' },
